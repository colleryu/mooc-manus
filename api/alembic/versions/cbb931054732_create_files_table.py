...
Revision ID: cbb931054732
Revises: e1d8698c0dd3
Create Date: 2026-08-26 19:15:42.703379
...
revision: str = 'cbb931054732'
down_revision: Union[str, Sequence[str], None] = 'e1d8698c0dd3'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=244), nullable=False),
