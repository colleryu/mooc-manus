...
class Sandbox(Protocol):
    """沙箱访问扩展协议，包含文件工具协议，shell工具协议已经沙箱本身的扩展"""

    async def exec_command(self, session_id:int, exec_dir:str, command:str)->ToolResult:
        """根据传递的会话id + 目录 + 命令执行对应的命令"""
        ...

    async def read_shell_output(self, session_id:int, console:bool = False)->ToolResult:
