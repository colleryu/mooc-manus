...
class BrowserTool(BaseTool):
    ...
    @tool(
        ...
        description="将浏览器导航至指定网页，当需要访问新网页时使用",
        parameters={
            "url":{
                "type": "string",
                "description": "要访问的完整URL,必须包含协议前缀(例如：https://)",
    ...
    @tool(
        ...
        description="在当前浏览器页面模拟按键，按需要指定的键盘操作时使用",
        parameters={
            "key":{
                "type":"string",
    ...
    @tool(
        ...
        description="查看浏览器控制台输出，用于检测JavaScript日志或调试页面错误",
        parameters={
            "max_lines":{
                "type":"integer",
