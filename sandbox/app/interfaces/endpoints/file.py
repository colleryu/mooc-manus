...
from app.interfaces.schema.file import FileCheckRequest, FileDeleteRequest, FileFindRequest, FileReadRequest, FileReplaceRequest, FileSearchRequest, FileWriteRequest
from app.models.file import FileCheckResult, FileDeleteResult, FileFindResult, FileReadResult, FileReplaceResult, FileSearchResult, FileUploadResult,FileWriteResult
...
async def replace_in_file(
    ...
    return Response.success(
        msg=f"文件内容替换完成，已替换{result.replaced_count}",
        data=result,
    )
