...
from app.interfaces.schema.shell import ShellExecuteRequest, ShellKillRequest, ShellReadRequest, ShellWaitRequest, ShellWriteRequest
...
async def wait_for_process(
    ...
    return Response.success(
        msg=f"进程结束，放回状态码(returncode):{result.returncode}",
        data= result
    )
