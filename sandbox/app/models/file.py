...
class FileUploadResult(BaseModel):
    ...
    filepath:str = Field(
        ...,
        description="上传文件的绝对路径"
    )
    file_size:int = Field(
        default=0,
        description="上传文件的大小，代为字节"
    )
    sucess:bool = Field(
        ...,
        description="是否上传成功"
